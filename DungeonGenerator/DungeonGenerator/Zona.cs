...
namespace DungeonGenerator
{
    class Zona
    {
        ...
        public Zona()
        {
            ...
            int nAreas = rnd.Next(Config.numeroMinAreas, Config.numeroMaxAreas); //Randomiza até 1 valor a menos, pois a primeira area já está criada.
        ...
        public void PreencherZona(Zona zonaInserida, Area areaPartida, int totalAreasCriadas, Vetor2[] coordAreas, int nAreas, Random rnd)
        {
            bool permissao;
            Vetor2 novaCoord;
        ...
        public void PreencherZonaLimitado(Zona zonaInserida, int totalAreasCriadas, Vetor2[] coordAreas, int nAreas, Random rnd)
        {
            int nAdjacentes;
                ...
                for (int j = 1; j < Config.tamanhoMatrizZona.y - 1; j++)
                {
                    if (zonaInserida.zona[i, j] != null)
                    {
                        ...
                        if (zonaInserida.zona[i, j - 1] != null)
                        {
                            ...
                            {
                                zonaInserida.zona[i, j].portas[2] = zonaInserida.zona[i, j - 1].posicaoMatriz;
                            }
                            if (zonaInserida.zona[i, j - 1].secreta == true)
                            {
                                zonaInserida.zona[i, j].portasSecretas[2] = zonaInserida.zona[i, j - 1].posicaoMatriz;
                            }
                        }
                        //baixo
                        if (zonaInserida.zona[i, j + 1] != null)
                        {
                            if (zonaInserida.zona[i, j + 1].secreta == false)
                            {
                                zonaInserida.zona[i, j].portas[3] = zonaInserida.zona[i, j + 1].posicaoMatriz;
                            }
                            if (zonaInserida.zona[i, j + 1].secreta == true)
                            {
                                zonaInserida.zona[i, j].portasSecretas[3] = zonaInserida.zona[i, j + 1].posicaoMatriz;
                            }
                        }
                        //esquerda
                        if (zonaInserida.zona[i - 1, j] != null)
                        {
                            ...
                            {
                                zonaInserida.zona[i, j].portas[0] = zonaInserida.zona[i - 1, j].posicaoMatriz;
                            }
                            if (zonaInserida.zona[i - 1, j].secreta == true)
                            {
                                zonaInserida.zona[i, j].portasSecretas[0] = zonaInserida.zona[i - 1, j].posicaoMatriz;
                            }
                        ...
                        if (zonaInserida.zona[i + 1, j] != null)
                        {
                            if (zonaInserida.zona[i + 1, j].secreta == false)
                            {
                                zonaInserida.zona[i, j].portas[1] = zonaInserida.zona[i + 1, j].posicaoMatriz;
                            }
                            if (zonaInserida.zona[i + 1, j].secreta == true)
                            {
                                zonaInserida.zona[i, j].portasSecretas[1] = zonaInserida.zona[i + 1, j].posicaoMatriz;
                            }
                        }
                        //FIM CHECAGEM
                    }
        ...
        public void PermitirAreasSecretas()
        {
            ...
            if (permissao == 3)
            {
                int nAreasSecretas = rnd.Next(0, nMaxAreasSecretas + 1);
                numeroDeAreasSecretas = nAreasSecretas;
                CriarAreasSecretas(this, 0, this.coordAreasSecretas, nAreasSecretas, rnd);
            }
        }

        public void CriarAreasSecretas(Zona zonaInserida, int totalAreasCriadas, Vetor2[] coordAreasSecretas, int nAreasSecretas, Random rnd)
        {
            int nAdjacentes;
            bool permissao = false;
            Vetor2 novaCoord;
